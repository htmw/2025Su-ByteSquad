        ...
        >
          ...
          >
            <CardMedia
              component="img"
              height="100%"
              image={supplement.imageUrl || 'https://images.unsplash.com/photo-1596177582967-a5d143a41237?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8c3VwcGxlbWVudHN8ZW58MHx8MHx8'}
              alt={supplement.name}
              sx={{ 
                objectFit: 'cover',
                height: '100%'
